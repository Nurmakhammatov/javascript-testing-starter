...
describe("getCoupons", () => {
  ...
  it("should return an arrray with valid coupon codes", () => {
    const coupons = getCoupons();
...
describe("calculateDiscount", () => {
  ...
  it("should handle non-numeric proce", () => {
...
describe("validateUserInput", () => {
  ...
  it("should return an error if both username andd age are invalid", () => {
...
describe("isPriceInRange", () => {
  it.each([
    ...
    { scenario: "price betweenmin and max", price: 50, result: true },
