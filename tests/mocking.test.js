...
describe('getShippingInfo', () => {
  it('should return shipping unavailable if quaote cannot be fetched', () => {
...
describe('submitOrder', () => {
  ...
  it('should return succes when payment is successfull', async () => {
    vi.mocked(charge).mockResolvedValue({ status: 'success' });
...
describe('signUp', () => {
  ...
  it('should return true if email is not valid', async () => {
...
describe('isOnline', () => {
  ...
  it('should return true if current hour is within openning hours', () => {
